...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    ...
    <a href="{{ route('compendium.npcs.index') }}"
       class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-900 mb-4 font-medium">
    ...
    <div class="bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden">
        {{-- HEADER --}}
        <div class="flex flex-col sm:flex-row items-start p-6 border-b border-gray-200 sm:items-center">
        ...
        @if($npc->description || $npc->personality || $npc->quirks)
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                @endif
                @if($npc->personality)
                    <p class="mb-4 italic text-gray-700">Personality: {{ $npc->personality }}</p>
                @endif
                @if($npc->quirks)
            ...
            <div class="p-6 bg-gray-50 border-b border-gray-200">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                    @foreach($stats as $stat)
                        @if(!is_null($npc->$stat))
                            <div class="bg-white border border-gray-200 rounded-lg p-3 text-center">
                                <div class="text-xs font-medium text-gray-600 uppercase">{{ ucfirst($stat) }}</div>
        ...
        @if($quests->isNotEmpty())
            <div class="p-6 bg-white border-t border-gray-200">
                <h2 class="text-lg font-semibold text-gray-700 mb-4">Quest Appearances</h2>
